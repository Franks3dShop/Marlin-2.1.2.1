...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_2_DESC "Endstop OFF"
  #define MAIN_MENU_ITEM_2_GCODE "M211 S0"
  //#define MAIN_MENU_ITEM_2_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_3_DESC "Enstop ON"
  #define MAIN_MENU_ITEM_3_GCODE "M211 S1"
  ...
  #define MAIN_MENU_ITEM_5_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nG28\nG29"
